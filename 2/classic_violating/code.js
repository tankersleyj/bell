// variables
var degChr=String.fromCharCode(176), primeChr=String.fromCharCode(180), animationId=0, author='J.Tankersley', version='0.6.1', imageTitle='Bell CHSH (in-progress, incomplete alpha)';
...
class Experiment {
    ...
    step (time) {
        ...
        function getKarmaPenyResult(prt,pol,debug) {
            let result=0; 
            // const delta=Math.abs(Math.abs(pol.axis)-Math.abs(prt.axis));
        ...
        function detectKarmaPeny(prt,pol,debug) {
            ...
            return (Math.random()<=detProb)?true:false;
        }
        ...
        if (this.phase==1 && this.distance>=(midX-startX)) {
            ...
            //   this.statText='(<i><b>not detected</b></i>)';
            }
